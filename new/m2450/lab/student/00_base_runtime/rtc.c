...
//	int res[100];
	...
	j = snprintf(buffer, sizeof(buffer), "%2d:", d_hour);
	j += snprintf(buffer+j, sizeof(buffer), "%2d:", d_min);
	j += snprintf(buffer+j, sizeof(buffer), "%2d", d_sec);
	j += snprintf(buffer+j, sizeof(buffer), "  %10s,  ", day[weekday]);
	j += snprintf(buffer+j, sizeof(buffer), "%2d/", d_month);
	j += snprintf(buffer+j, sizeof(buffer), "%2d/", d_date);
	j += snprintf(buffer+j, sizeof(buffer), "%4d", d_year);
